...
HddDevices=       '-Class Win32_DiskDrive,MSStorageDriver_FailurePredictStatus -ScriptBlock $SbHddDevices'
...
if ($?)
    {
    $temp = '' | Select-Object PSJobTypeName,WmiJob,StartTime,Location,Class
                    ...
                    if ($ParamProperty)
                        ...
                        elseif ($ParamScriptblock -and !($Keys -eq "UseRunspace" ))
                            ...
                            elseif (!($Keys -eq "UseRunspace" ))
                                {
                                Write-Verbose ("$ComputerName Add to result $Property=$"+"$($PropertyParams[$Property].class)")
                                $HashtableResult[$ComputerName].$Property=Get-Variable -Name $PropertyParams[$Property].class -ValueOnly
                                }
...
$WmiParam.Add("Class",$Class)
$WmiParam.Add("Namespace",$Namespace)
if ($ManualNamespaceParamQuery)
    {
    $WmiParam.Add("Query",$ManualNamespaceParamQuery["Query"])
